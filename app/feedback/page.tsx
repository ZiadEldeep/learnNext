...
const feedbacks: Feedback[] = [
  {
    ...
    date: "August 20, 2024",
    image: "/image/chefs-3.jpg", // Replace with the actual path to the image
  },
  {
    id: 2,
    name: "Bob",
    ...
    date: "August 21, 2024",
    image: "/image/chefs-1.jpg", // Replace with the actual path to the image
  },
  {
    id: 3,
    name: "Charlie",
    ...
    date: "August 22, 2024",
    image: "/image/chefs-2.jpg", // Replace with the actual path to the image
  },
...
const FeedbackComponent = () => {
  return (
    <div className="container mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold mb-8 text-center">Customer Feedback</h1>
